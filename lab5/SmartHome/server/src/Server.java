...
//            ObjectAdapter adapter = communicator.createObjectAdapterWithEndpoints("Adapter", "tcp -h 127.0.0.2 -p 10000 -z : udp -h 127.0.0.2 -p 10000 -z");
            ...
            adapter.add(wihajsterServant, new Identity("wihajster", "wihajsters"));
            adapter.add(blackCoffeeMachineServant, new Identity("blackCoffeeMachine", "coffeeMachines"));
            adapter.add(milkCoffeeMachineServant, new Identity("milkCoffeeMachine", "coffeeMachines"));
